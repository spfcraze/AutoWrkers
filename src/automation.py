...
"""
        ...
        pr_body += """
---
🤖 This PR was automatically generated by [UltraClaude](https://github.com/ultraclaude)
"""
...
class AutomationController:
    ...
    async def start_issue_session(self, issue_session: IssueSession):
        ...
        try:
            ...
            # Create UltraClaude session with LLM configuration
    ...
    async def _check_completed_sessions(self, project_id: int):
        ...
        for issue_session in in_progress:
            ...
            # Check if UltraClaude session is completed
